<section class="principalForget">
    ...
    <div class="fila-form-forget">
        <div class="col-12">
            <div class="signup">
                <input type="radio" name="usertype" value="traveller" class="radio-signup" required> Soy un traveller
                <input type="radio" name="usertype" value="owner" class="radio-signup"> Soy un anfitrión<br>
